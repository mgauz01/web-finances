...
const expenseOne = store.dispatch(addExpense({description: 'Rent', amount: 100, createdAt: -9000}))
...
const expenses = {
    expenses: [{
        id: 'iyifiihsjs',
        description: 'lol idk dude',
        note: 'this wa sthe final payment for that adress',
        amount: 54500,
        createdAt: 0
